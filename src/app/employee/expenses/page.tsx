    ...
    <ProtectedRoute allowedRoles={['employee']}>
      <DashboardLayout>
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-blue-200/70">Record expenses paid from your accounts for the day.</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {accountBalances.map((account) => (
            <div key={account.key} className={`rounded-xl border p-4 ${account.bgColor}`}>
              ...
              <div className="text-xs text-gray-500 dark:text-blue-200/70 mb-1">Received</div>
              ...
              {account.spent > 0 && (
                <div className="mt-2 pt-2 border-t border-gray-200 dark:border-navy-200/20">
                  <div className="flex justify-between text-xs">
                    <span className="text-gray-500 dark:text-blue-200/70">Spent</span>
          ...
          <div className="flex items-center gap-4">
            ...
            {report && (
              <div className="flex-1 text-right">
                <span className="text-sm text-gray-500 dark:text-blue-200/70">Report Total Sales:</span>
        ...
        {loading ? (
          <div className="card text-center py-8">
            ...
            <p className="text-gray-500 dark:text-blue-200/70 mt-3">Loading...</p>
          </div>
        ) : noReport ? (
          <div className="card text-center py-8">
            ...
            <p className="text-gray-500 dark:text-blue-200/70">No sales report found for this date.</p>
          ...
          <>
            ...
            <div className="card">
              ...
              {expenses.length === 0 ? (
                <p className="text-gray-500 dark:text-blue-200/70 text-sm py-4 text-center">No expenses yet. Click &quot;+ Add Expense&quot; to get started.</p>
              ) : (
                <div className="space-y-3">
                  {expenses.map((expense, index) => (
                    <div key={index} className="p-4 bg-gray-50 dark:bg-navy-800/50 rounded-lg">
                      <div className="flex gap-3 items-start">
                        <div className="flex-1">
                          <label className="text-xs text-gray-500 dark:text-blue-200/70 mb-1 block">Description</label>
                          <input
                            type="text"
                        ...
                        <div className="w-32">
                          <label className="text-xs text-gray-500 dark:text-blue-200/70 mb-1 block">Amount</label>
                          <input
                            type="number"
                            step="0.01"
                            min="0"
                        ...
                        <div className="w-44">
                          <label className="text-xs text-gray-500 dark:text-blue-200/70 mb-1 block">Paid From</label>
                          <select
              ...
              {expenses.length > 0 && (
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-navy-200/15 flex justify-between items-center">
              ...
              {expenses.length === 0 && (
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-navy-200/15 flex justify-end">
                  <button
                    onClick={handleSave}
                    disabled={saving}
                    className="btn-primary px-6"
