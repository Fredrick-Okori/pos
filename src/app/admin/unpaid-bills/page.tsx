    ...
    <ProtectedRoute allowedRoles={['superadmin']}>
      <DashboardLayout>
        <div className="mb-8">
          ...
          <p className="text-gray-500">Track and manage all unpaid customer bills</p>
        </div>
        ...
        {loading ? (
          <div className="card text-center py-8">
            ...
            <p className="mt-2 text-gray-500">Loading unpaid bills...</p>
          </div>
          ...
          <div className="card text-center py-12">
            ...
            <p className="text-gray-400">No unpaid bills found</p>
          </div>
        ) : (
                ...
                <div className="flex justify-between items-center mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">{customer.bills.length} unpaid bill(s)</p>
                    </div>
                  </div>
